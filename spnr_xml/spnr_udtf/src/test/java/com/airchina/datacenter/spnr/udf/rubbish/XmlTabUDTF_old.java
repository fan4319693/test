//package com.airchina.datacenter.spnr.udf.rubbish;
//
...
//import com.airchina.datacenter.spnr.udf.rubbish.pojo.XmlParserEx;
//import com.airchina.datacenter.spnr.udf.rubbish.processor.Dispatcher;
//import com.airchina.datacenter.spnr.udf.rubbish.processor.XmlProcessor;
//import com.airchina.datacenter.spnr.udf.rubbish.utils.KafkaDao;
//
//public class XmlTabUDTF_old extends GenericUDTF {
//
////    private static final Log log = LogFactory.getLog(XmlTabUDTF_old.class);
...
//            throw new UDFArgumentException("First param must String");
//        }
