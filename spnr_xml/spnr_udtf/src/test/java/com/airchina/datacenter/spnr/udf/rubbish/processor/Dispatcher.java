package com.airchina.datacenter.spnr.udf.rubbish.processor;
...
//
//        DISPATCHER.put("MP_AP_GroundTransportPo".toLowerCase(), new XmlProcessor(MP_AP_GroundTransportPo.class));
//        DISPATCHER.put("MP_AP_LoungePo".toLowerCase(), new XmlProcessor(MP_AP_LoungePo.class));
//        DISPATCHER.put("MP_AP_TicketingPo".toLowerCase(), new XmlProcessor(MP_AP_TicketingPo.class));
//
//        //范帅添加
//        DISPATCHER.put("MP_AP_SegmentPo".toLowerCase(), new XmlProcessor(MP_AP_SegmentPo.class));
//        DISPATCHER.put("MP_AP_TravelerPo".toLowerCase(), new XmlProcessor(MP_AP_TravelerPo.class));
//        DISPATCHER.put("MP_Baggage_SegmentPo".toLowerCase(), new XmlProcessor(MP_Baggage_SegmentPo.class));
//        DISPATCHER.put("MP_Baggage_TravelerPo".toLowerCase(), new XmlProcessor(MP_Baggage_TravelerPo.class));
//    }
//
...
//        }
//
//        if (spnrContext.getMpApGroundTransportPoList() != null) {
//            ans.put("MP_AP_GroundTransportPo".toLowerCase(), spnrContext.getMpApGroundTransportPoList());
//        }
//
//        if (spnrContext.getMpApLoungePoList() != null) {
//            ans.put("MP_AP_LoungePo".toLowerCase(), spnrContext.getMpApLoungePoList());
//        }
//
//        if (spnrContext.getMpApTicketingPoList() != null) {
//            ans.put("MP_AP_TicketingPo".toLowerCase(), spnrContext.getMpApTicketingPoList());
//        }
//
//        //范帅添加
//        if(spnrContext.getMpApSegmentList() != null){
//            ans.put("MP_AP_SegmentPo".toLowerCase(), spnrContext.getMpApSegmentList());
//        }
//
//        if(spnrContext.getMpApTravelerList() != null){
//            ans.put("MP_AP_TravelerPo".toLowerCase(), spnrContext.getMpApTravelerList());
//        }
//
//        if(spnrContext.getMpBaggageSegmentList() != null){
//            ans.put("MP_Baggage_SegmentPo".toLowerCase(), spnrContext.getMpBaggageSegmentList());
//        }
//
//        if(spnrContext.getMpBaggageTravelerList() != null){
//            ans.put("MP_Baggage_TravelerPo".toLowerCase(), spnrContext.getMpBaggageTravelerList());
//        }
//
//        return ans;
//    }
