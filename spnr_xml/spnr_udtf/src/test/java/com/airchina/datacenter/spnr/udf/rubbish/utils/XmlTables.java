...
//
//        TABLE_CLASSES.put("MP_AP_GroundTransportPo".toLowerCase(),
//                new ClassMapper(MP_AP_GroundTransportPo.class, SPNRContext::getMpApGroundTransportPoList, FUNC));
//
//        TABLE_CLASSES.put("MP_AP_LoungePo".toLowerCase(),
//                new ClassMapper(MP_AP_LoungePo.class, SPNRContext::getMpApLoungePoList, FUNC));
//
//        TABLE_CLASSES.put("MP_AP_TicketingPo".toLowerCase(),
//                new ClassMapper(MP_AP_TicketingPo.class, SPNRContext::getMpApTicketingPoList, FUNC));
//
