...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.sdk.entity.AvailRequestSegmentsType.AvailRequestSegment.StayDateRange.class,
    com.airchina.datacenter.spnr.sdk.entity.RoomStayType.TimeSpan.class
})
