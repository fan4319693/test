...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.LoyaltyProductType.Earn.class,
    PackageEarnType.class,
    com.airchina.datacenter.spnr.entity.PaymentLoyaltyType.Earn.class,
    com.airchina.datacenter.spnr.entity.LoyaltyPricingType.Combinations.Combination.Earn.class,
    com.airchina.datacenter.spnr.entity.LoyaltyDetailsPricingType.Combinations.Combination.Earn.class,
    com.airchina.datacenter.spnr.entity.LoyaltyPTCType.PTC.Earn.class,
    com.airchina.datacenter.spnr.entity.LoyaltyPricingType.Earn.class
})
