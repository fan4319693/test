...
/**
 * Information about profile beneficiary(s).
 * 
 * <p>BeneficiaryType complex type的 Java 类。
 * 
...
public class BeneficiaryType {
    ...
    protected List<BeneficiaryType.Telephone> telephone;
     ...
     * {@link BeneficiaryType.Telephone }
     * 
     * 
     */
    public List<BeneficiaryType.Telephone> getTelephone() {
        if (telephone == null) {
            telephone = new ArrayList<BeneficiaryType.Telephone>();
        }
