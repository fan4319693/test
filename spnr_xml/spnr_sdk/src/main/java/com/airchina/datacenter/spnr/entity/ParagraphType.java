...
@XmlSeeAlso({
    ...
    com.airchina.datacenter.spnr.entity.TextDescriptionType.ShortDescription.class,
    com.airchina.datacenter.spnr.entity.SpecialRequestType.SpecialRequest.class,
    com.airchina.datacenter.spnr.entity.CommentType.Comment.class,
    com.airchina.datacenter.spnr.entity.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.airchina.datacenter.spnr.entity.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    com.airchina.datacenter.spnr.entity.FormattedTextSubSectionType.Paragraph.class,
    com.airchina.datacenter.spnr.entity.VehicleLocationAdditionalDetailsType.VehRentLocInfos.VehRentLocInfo.Keywords.Keyword.class,
    com.airchina.datacenter.spnr.entity.WrittenConfInstType.SupplementalData.class,
    MultimediaObjectType.class
})
