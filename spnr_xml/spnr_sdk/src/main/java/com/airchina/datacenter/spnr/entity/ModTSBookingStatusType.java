 ...
 *     &lt;enumeration value="APPLY_FAIL"/>
 *     &lt;enumeration value="POST_APPLYING"/>
 *     &lt;enumeration value="ISSUED"/>
 *     &lt;enumeration value="ISSUE_FAIL"/>
 *     &lt;enumeration value="BOARDED"/>
 *     &lt;enumeration value="BOARDED_TIMEOUT"/>
 *     &lt;enumeration value="COMPLETED_TIMEOUT"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum ModTSBookingStatusType {
    ...
    /**
     * Indicates that the reimbursement application is failed.
     * 
     */
    APPLY_FAIL,

    /**
     * Indicates that the reimbursement is under mailing application.
     * 
     */
    POST_APPLYING,

    /**
     * Indicates that the reimbursement is successfully issued.
     * 
     */
    ISSUED,

    /**
     * Indicates that the reimbursement is failed issued.
     * 
     */
    ISSUE_FAIL,

    /**
     * Indicates that the traveller has boarded.
     * 
     */
    BOARDED,

    /**
     * Indicates that the traveller has run overtime to get on the transport and the overtime fees are being calculated.
     * 
     */
    BOARDED_TIMEOUT,

    /**
     * Indicates that the traveller has boarded overtime and the service completed.
     * 
     */
    COMPLETED_TIMEOUT;
