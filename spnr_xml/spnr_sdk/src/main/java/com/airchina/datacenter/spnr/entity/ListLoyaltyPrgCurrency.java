...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.CodeListFeeType.Amount.AlternateCurrency.class,
    com.airchina.datacenter.spnr.entity.CodeListFeeType.Taxes.Amount.AlternateCurrency.class
})
