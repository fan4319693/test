...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.CodeListFeeType.Qualifiers.ChargeUnit.Unit.class,
    com.airchina.datacenter.spnr.entity.CodeListFeeType.Taxes.Qualifiers.ChargeUnit.Unit.class
})
