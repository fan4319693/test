...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.TicketingFullInfoType.PassengerInfo.ContactInfo.class,
    com.airchina.datacenter.spnr.entity.RecipientInfosType.RecipientInfo.class,
    FerryContactPersonType.class,
    com.airchina.datacenter.spnr.entity.CruiseGuestDetailType.ContactInfo.class,
    com.airchina.datacenter.spnr.entity.HotelRoomListType.Guests.Guest.class,
    com.airchina.datacenter.spnr.entity.HotelRoomListType.MasterContact.class
})
