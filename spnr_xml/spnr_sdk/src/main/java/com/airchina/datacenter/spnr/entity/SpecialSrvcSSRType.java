...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.SpecialSrvcType.SSRType.class,
    com.airchina.datacenter.spnr.entity.SpecialSrvcSegType.SSRType.class,
    com.airchina.datacenter.spnr.entity.SpecialSrvcPaxType.SSRType.class
})
