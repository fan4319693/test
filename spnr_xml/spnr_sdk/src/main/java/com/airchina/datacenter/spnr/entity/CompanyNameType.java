...
@XmlSeeAlso({
    ...
    com.airchina.datacenter.spnr.entity.AllianceConsortiumType.AllianceMember.class,
    com.airchina.datacenter.spnr.entity.VehicleSegmentCoreType.Vendor.class,
    TravelArrangerType.class,
    FerryCompanyNameType.class,
    com.airchina.datacenter.spnr.entity.VehicleAvailCoreType.Vendor.class,
    CompanyNamePrefType.class,
    com.airchina.datacenter.spnr.entity.FlightSegmentType.MarketingAirline.class,
    com.airchina.datacenter.spnr.entity.DirectBillType.CompanyName.class,
    com.airchina.datacenter.spnr.entity.ContactInfoType.CompanyName.class
})
