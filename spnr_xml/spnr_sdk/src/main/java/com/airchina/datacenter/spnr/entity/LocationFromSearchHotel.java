...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.SearchType.OriginDestinationInformation.Origin.class,
    com.airchina.datacenter.spnr.entity.SearchType.OriginDestinationInformation.Destination.class
})
