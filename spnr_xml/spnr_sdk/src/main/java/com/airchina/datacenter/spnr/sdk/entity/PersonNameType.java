...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.sdk.entity.TravelClubType.ClubMemberName.class,
    com.airchina.datacenter.spnr.sdk.entity.ContactsType.Name.class,
    FerryPersonNameType.class,
    com.airchina.datacenter.spnr.sdk.entity.OrganizationType.OrgMemberName.class,
    com.airchina.datacenter.spnr.sdk.entity.VerificationType.PersonName.class,
    com.airchina.datacenter.spnr.sdk.entity.CoveredTravelerType.CoveredPerson.class,
    com.airchina.datacenter.spnr.sdk.entity.CoveredTravelerType.Beneficiary.Name.class
})
