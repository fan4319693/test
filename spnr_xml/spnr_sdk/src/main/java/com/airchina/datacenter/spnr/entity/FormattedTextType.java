...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    com.airchina.datacenter.spnr.entity.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class,
    com.airchina.datacenter.spnr.entity.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    VehicleLocationInformationType.class,
    com.airchina.datacenter.spnr.entity.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class,
