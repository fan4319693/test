...
/**
 * <p>SPNR_Email_Type complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SPNR_Email_Type">
 *   &lt;complexContent>
 ...
 *       &lt;attribute name="Email" type="{http://www.opentravel.org/OTA/2003/05}StringLength1to128" />
...
@XmlType(name = "SPNR_Email_Type", propOrder = {
    "attachments",
    "error"
})
public class SPNREmailType {

    @XmlElement(name = "Attachments")
    protected SPNREmailType.Attachments attachments;
     ...
     * @return
     *     possible object is
     *     {@link SPNREmailType.Attachments }
     *     
     */
    public SPNREmailType.Attachments getAttachments() {
        return attachments;
    }
     ...
     *     
     */
    public void setAttachments(SPNREmailType.Attachments value) {
    ...
    public static class Attachments {
        ...
        protected List<SPNREmailType.Attachments.Attachment> attachment;
         ...
         * {@link SPNREmailType.Attachments.Attachment }
         * 
         * 
         */
        public List<SPNREmailType.Attachments.Attachment> getAttachment() {
            if (attachment == null) {
                attachment = new ArrayList<SPNREmailType.Attachments.Attachment>();
            }
