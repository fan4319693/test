...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.MultimediaObjectsType.MultimediaObject.class,
    com.airchina.datacenter.spnr.entity.HotelInfoType.Descriptions.Description.class
})
