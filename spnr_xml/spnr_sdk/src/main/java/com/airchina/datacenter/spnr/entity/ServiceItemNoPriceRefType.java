...
/**
 * Core NON-PRICED ancillary service item with segment and traveler reference definition.
 * 
 * <p>ServiceItemNoPriceRefType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ServiceItemNoPriceRefType">
 *   &lt;complexContent>
...
@XmlType(name = "ServiceItemNoPriceRefType", propOrder = {
    "segmentIDRef",
    "travelerIDRef",
    "serviceID",
    "forInfo",
...
public class ServiceItemNoPriceRefType {
    ...
    protected ServiceItemNoPriceRefType.BookingInstructions bookingInstructions;
    @XmlElement(name = "Endorsement")
    protected List<ServiceItemNoPriceRefType.Endorsement> endorsement;
    ...
    /**
     * Unique (non-priced) Service ID.
     * 						Example: C001
     * 
     * 						=notes=
     * 						1. This is a unique ID provided by the airline for a non-priced ancillary service that may be part of an Ancillary Service Bundle.
     * 
     * 						2. An additional OfferID may be specified in the ServicePrice element if this is a priced offer. Note that if this is a priced offer, the ServiceID specified here becomes part of the Priced Offer.
     * 
     * @return
     *     possible object is
     *     {@link ServiceID }
     ...
     * @return
     *     possible object is
     *     {@link ServiceItemNoPriceRefType.BookingInstructions }
     *     
     */
    public ServiceItemNoPriceRefType.BookingInstructions getBookingInstructions() {
     ...
     *     
     */
    public void setBookingInstructions(ServiceItemNoPriceRefType.BookingInstructions value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ServiceItemNoPriceRefType.Endorsement }
     * 
     * 
     */
    public List<ServiceItemNoPriceRefType.Endorsement> getEndorsement() {
        if (endorsement == null) {
            endorsement = new ArrayList<ServiceItemNoPriceRefType.Endorsement>();
        }
    ...
    public static class BookingInstructions {
        ...
        protected ServiceItemNoPriceRefType.BookingInstructions.UpgradeMethod upgradeMethod;
         ...
         * @return
         *     possible object is
         *     {@link ServiceItemNoPriceRefType.BookingInstructions.UpgradeMethod }
         *     
         */
        public ServiceItemNoPriceRefType.BookingInstructions.UpgradeMethod getUpgradeMethod() {
         ...
         *     
         */
        public void setUpgradeMethod(ServiceItemNoPriceRefType.BookingInstructions.UpgradeMethod value) {
