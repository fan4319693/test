...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.AirItineraryPricingInfoType.SpecialServiceRequests.SpecialServiceRequest.class,
    com.airchina.datacenter.spnr.entity.SpecialReqDetailsType.SpecialServiceRequests.SpecialServiceRequest.class
})
