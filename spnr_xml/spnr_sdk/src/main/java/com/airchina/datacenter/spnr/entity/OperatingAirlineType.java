...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.TicketingFullInfoType.FlightInfo.CarrierInfo.class,
    com.airchina.datacenter.spnr.entity.VerificationPNR.Product.Air.class
})
