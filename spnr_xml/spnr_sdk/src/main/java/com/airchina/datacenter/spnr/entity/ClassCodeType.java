...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.JourneySegmentType.TrainSegment.AvailabilityDetail.ClassCode.class,
    com.airchina.datacenter.spnr.entity.JourneySegmentType.BusSegment.ClassCodes.class
})
