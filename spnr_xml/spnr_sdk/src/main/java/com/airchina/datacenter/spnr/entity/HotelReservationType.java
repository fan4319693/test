...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.ProductBase.Hotel.class,
    com.airchina.datacenter.spnr.entity.HotelResModifyType.HotelResModify.class,
    com.airchina.datacenter.spnr.entity.HotelReservationsType.HotelReservation.class
})
