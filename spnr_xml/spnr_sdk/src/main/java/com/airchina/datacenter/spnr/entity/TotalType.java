...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.Rates.Rate.TotalRate.class,
    com.airchina.datacenter.spnr.entity.AmountType.Base.class,
    com.airchina.datacenter.spnr.entity.AmountType.Total.class,
    com.airchina.datacenter.spnr.entity.ItinPricingType.Cost.class,
    com.airchina.datacenter.spnr.entity.TravelCostType.CostTotals.class,
    DiscountType.class,
    com.airchina.datacenter.spnr.entity.RateUploadType.BaseByGuestAmts.BaseByGuestAmt.class
})
