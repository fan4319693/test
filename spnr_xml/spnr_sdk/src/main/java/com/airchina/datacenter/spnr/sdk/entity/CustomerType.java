...
@XmlSeeAlso({
    ...
    com.airchina.datacenter.spnr.sdk.entity.OJCustomerPrimaryAdditionalType.Additional.class,
    InsuranceCustomerType.class,
    com.airchina.datacenter.spnr.sdk.entity.CustomerPrimaryAdditionalType.Additional.class
})
