...
/**
 * Exempt tax information.
 * 
 * <p>ExemptTaxType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ExemptTaxType">
 *   &lt;complexContent>
...
@XmlType(name = "ExemptTaxType", propOrder = {
    "tax"
})
public class ExemptTaxType {

    @XmlElement(name = "Tax")
    protected List<ExemptTaxType.Tax> tax;
     ...
     * {@link ExemptTaxType.Tax }
     * 
     * 
     */
    public List<ExemptTaxType.Tax> getTax() {
        if (tax == null) {
            tax = new ArrayList<ExemptTaxType.Tax>();
        }
        return this.tax;
    }
    ...
    public static class Tax {
        ...
        protected List<ExemptTaxType.Tax.CollectionPoint> collectionPoint;
        @XmlAttribute(name = "Amount", required = true)
        protected BigInteger amount;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ExemptTaxType.Tax.CollectionPoint }
         * 
         * 
         */
        public List<ExemptTaxType.Tax.CollectionPoint> getCollectionPoint() {
            if (collectionPoint == null) {
                collectionPoint = new ArrayList<ExemptTaxType.Tax.CollectionPoint>();
            }
