 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="DeliveryTimeInfo" minOccurs="0">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="ScheduledDispatchTimeSpan" minOccurs="0">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;attGroup ref="{http://www.opentravel.org/OTA/2003/05}DateTimeSpanGroup"/>
 ...
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="EstimatedDeliveryTimeSpan" minOccurs="0">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;attGroup ref="{http://www.opentravel.org/OTA/2003/05}DateTimeSpanGroup"/>
    ...
    extends VerificationType
{
    ...
    protected VerificationPNR.Fulfillment fulfillment;
     ...
     * @return
     *     possible object is
     *     {@link VerificationPNR.Fulfillment }
     *     
     */
    public VerificationPNR.Fulfillment getFulfillment() {
        return fulfillment;
    }
     ...
     *     
     */
    public void setFulfillment(VerificationPNR.Fulfillment value) {
    ...
    public static class Fulfillment {
        ...
        @XmlElement(name = "DeliveryTimeInfo")
        protected VerificationPNR.Fulfillment.DeliveryTimeInfo deliveryTimeInfo;
        ...
        /**
         * 获取deliveryTimeInfo属性的值。
         * 
         * @return
         *     possible object is
         *     {@link VerificationPNR.Fulfillment.DeliveryTimeInfo }
         *     
         */
        public VerificationPNR.Fulfillment.DeliveryTimeInfo getDeliveryTimeInfo() {
            return deliveryTimeInfo;
        }

        /**
         * 设置deliveryTimeInfo属性的值。
         * 
         * @param value
         *     allowed object is
         *     {@link VerificationPNR.Fulfillment.DeliveryTimeInfo }
         *     
         */
        public void setDeliveryTimeInfo(VerificationPNR.Fulfillment.DeliveryTimeInfo value) {
            this.deliveryTimeInfo = value;
        }

        /**
         * 获取deliveryMethod属性的值。
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "", propOrder = {
            "scheduledDispatchTimeSpan",
            "estimatedDeliveryTimeSpan"
        })
        public static class DeliveryTimeInfo {

            @XmlElement(name = "ScheduledDispatchTimeSpan")
            protected VerificationPNR.Fulfillment.DeliveryTimeInfo.ScheduledDispatchTimeSpan scheduledDispatchTimeSpan;
            @XmlElement(name = "EstimatedDeliveryTimeSpan")
            protected VerificationPNR.Fulfillment.DeliveryTimeInfo.EstimatedDeliveryTimeSpan estimatedDeliveryTimeSpan;

            /**
             * 获取scheduledDispatchTimeSpan属性的值。
             * 
             * @return
             *     possible object is
             *     {@link VerificationPNR.Fulfillment.DeliveryTimeInfo.ScheduledDispatchTimeSpan }
             *     
             */
            public VerificationPNR.Fulfillment.DeliveryTimeInfo.ScheduledDispatchTimeSpan getScheduledDispatchTimeSpan() {
                return scheduledDispatchTimeSpan;
            }

            /**
             * 设置scheduledDispatchTimeSpan属性的值。
             * 
             * @param value
             *     allowed object is
             *     {@link VerificationPNR.Fulfillment.DeliveryTimeInfo.ScheduledDispatchTimeSpan }
             *     
             */
            public void setScheduledDispatchTimeSpan(VerificationPNR.Fulfillment.DeliveryTimeInfo.ScheduledDispatchTimeSpan value) {
                this.scheduledDispatchTimeSpan = value;
            }

            /**
             * 获取estimatedDeliveryTimeSpan属性的值。
             * 
             * @return
             *     possible object is
             *     {@link VerificationPNR.Fulfillment.DeliveryTimeInfo.EstimatedDeliveryTimeSpan }
             *     
             */
            public VerificationPNR.Fulfillment.DeliveryTimeInfo.EstimatedDeliveryTimeSpan getEstimatedDeliveryTimeSpan() {
                return estimatedDeliveryTimeSpan;
            }

            /**
             * 设置estimatedDeliveryTimeSpan属性的值。
             * 
             * @param value
             *     allowed object is
             *     {@link VerificationPNR.Fulfillment.DeliveryTimeInfo.EstimatedDeliveryTimeSpan }
             *     
             */
            public void setEstimatedDeliveryTimeSpan(VerificationPNR.Fulfillment.DeliveryTimeInfo.EstimatedDeliveryTimeSpan value) {
                this.estimatedDeliveryTimeSpan = value;
            }
            ...
            @XmlAccessorType(XmlAccessType.FIELD)
            @XmlType(name = "")
            public static class EstimatedDeliveryTimeSpan {
            ...
            @XmlAccessorType(XmlAccessType.FIELD)
            @XmlType(name = "")
            public static class ScheduledDispatchTimeSpan {
