...
/**
 * <p>CabinDetail complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CabinDetail">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="CabinDetails" type="{http://www.opentravel.org/OTA/2003/05}CabinDetails" maxOccurs="99" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CabinDetail", propOrder = {
    "cabinDetails"
})
public class CabinDetail {

    @XmlElement(name = "CabinDetails")
    protected List<CabinDetails> cabinDetails;
    ...
    public List<CabinDetails> getCabinDetails() {
        if (cabinDetails == null) {
            cabinDetails = new ArrayList<CabinDetails>();
        }
