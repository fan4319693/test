...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.LoyaltyDetailType.Document.class,
    com.airchina.datacenter.spnr.entity.ContactPersonType.Document.class,
    com.airchina.datacenter.spnr.entity.AirTravelerType.Document.class
})
