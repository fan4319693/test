...
/**
 * Core PRICED ancillary service item with segment and traveler reference definition.
 * 
 * <p>ServiceItemRefType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ServiceItemRefType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.opentravel.org/OTA/2003/05}ServiceItemCoreType">
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentravel.org/OTA/2003/05}SegmentIDRef" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.opentravel.org/OTA/2003/05}TravelerIDRef" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ServiceItemRefType", propOrder = {
    "segmentIDRef",
    "travelerIDRef"
})
public class ServiceItemRefType
    extends ServiceItemCoreType
{
