 ...
 */
@Data
public class Mp_Activity_AirInfoPo implements Cloneable {
    /**
     * 功能说明: SPNR ID，唯一标识
     * 最后修改时间: 2023/06/02
     */
    ...
    @Override
    public Mp_Activity_AirInfoPo clone() {
        try {
            Mp_Activity_AirInfoPo clone = (Mp_Activity_AirInfoPo) super.clone();
            return clone;
