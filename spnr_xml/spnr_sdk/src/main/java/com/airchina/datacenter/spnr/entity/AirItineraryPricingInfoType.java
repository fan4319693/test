...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.AirSearchCriteriaType.AirItineraryPricingInfo.class,
    com.airchina.datacenter.spnr.entity.PricedItineraryType.AirItineraryPricingInfo.class,
    BookingPriceInfoType.class,
    com.airchina.datacenter.spnr.entity.AirReservationType.AirItineraryPricingInfo.class
})
