 ...
 * 
 * <p>PromotionsType complex type的 Java 类。
 * 
 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://www.opentravel.org/OTA/2003/05}PromotionType">
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
...
public class PromotionsType {
    ...
    protected List<PromotionsType.Promotion> promotion;
     ...
     * {@link PromotionsType.Promotion }
     * 
     * 
     */
    public List<PromotionsType.Promotion> getPromotion() {
        if (promotion == null) {
            promotion = new ArrayList<PromotionsType.Promotion>();
        }
