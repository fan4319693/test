...
@XmlSeeAlso({
    com.airchina.datacenter.spnr.entity.VehicleAgeRequirementsType.Age.Vehicles.Vehicle.class,
    VehiclePrefType.class,
    com.airchina.datacenter.spnr.entity.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle.class,
    VehicleType.class
})
